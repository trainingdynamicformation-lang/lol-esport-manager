...
const I18N = {
  fr: {
    ...
    'fans.feedPrev': 'Précédent',
    'fans.feedNext': 'Suivant',
    'fans.feedPage': 'Page {n} / {total}',
    'fans.feedCtxMatch': 'Match {my} contre {opp} — Compétition : {comp} / {stage}',
    'fans.feedCtxTitle': 'Compétition : {comp} — {stage}',
    'fans.feedMatchday': 'journée {n}',
    'fans.feedGroupStage': 'Phase de groupes',
    'fans.feedStageChampion': 'Champion',
    'fans.feedStageEliminated': 'Éliminé',
    ...
    'fans.feedTag.sponsorRegionalWin': 'Sponsor',
    'fans.feedTag.sponsorRegionalLoss': 'Sponsor',
    'fans.feedTag.sponsorIntlWin': 'Sponsor',
    'fans.feedTag.sponsorIntlLoss': 'Sponsor',
    ...
    // -- Banque de posts sponsor du fil des fans (v1.19.3) --
    'fanpost.sponsorRegionalWin.0': "{sponsor} est fier de s'associer à une organisation qui rayonne à l'international. Bravo à {team} pour ce titre {comp} — une nouvelle preuve que l'excellence est notre standard commun.",
    'fanpost.sponsorRegionalWin.1': "Chez {sponsor}, nous investissons dans les champions. {team} vient de le prouver en {comp}. Cap sur la suite.",
    'fanpost.sponsorRegionalWin.2': "{sponsor} félicite chaleureusement {team} pour son parcours en {comp}. Ce genre de performance, c'est exactement pourquoi nous sommes partenaires.",
    'fanpost.sponsorRegionalWin.3': "Fiers de porter les couleurs de {team} cette saison. {sponsor} salue une qualification méritée en {comp}.",
    'fanpost.sponsorRegionalWin.4': "Petite structure, grandes émotions : {sponsor} est aux côtés de {team} depuis le début, et cette réussite en {comp} nous touche particulièrement.",
    'fanpost.sponsorRegionalWin.5': "{comp} confirme ce que nous savions déjà : {team} appartient à l'élite. {sponsor} est fier de porter cette ambition à ses côtés.",
    'fanpost.sponsorRegionalWin.6': "Une belle saison {comp} pour {team}, et {sponsor} en fait partie intégrante. Merci pour ces émotions.",
    'fanpost.sponsorRegionalWin.7': "{sponsor} lève son verre à {team} : quelle saison {comp} ! On grandit ensemble, match après match.",
    'fanpost.sponsorRegionalLoss.0': "{sponsor} reste pleinement engagé aux côtés de {team}. Une saison {comp} en dessous des attentes, mais notre confiance dans ce projet ne faiblit pas.",
    'fanpost.sponsorRegionalLoss.1': "Les résultats de {comp} ne reflètent pas le potentiel que nous voyons chez {team}. {sponsor} continue d'investir dans cette ambition commune.",
    'fanpost.sponsorRegionalLoss.2': "{sponsor} prend acte d'une saison {comp} difficile pour {team}. Le partenariat continue, avec l'attente d'un rebond rapide.",
    'fanpost.sponsorRegionalLoss.3': "Ce n'était pas le résultat espéré en {comp}, mais {sponsor} croit toujours au projet {team}. On se relève ensemble.",
    'fanpost.sponsorRegionalLoss.4': "{sponsor} reste derrière {team} malgré une saison {comp} compliquée. C'est dans les moments comme celui-ci qu'un vrai partenaire se reconnaît.",
    'fanpost.sponsorRegionalLoss.5': "{sponsor} analyse cette saison {comp} avec lucidité, mais sans jamais remettre en question son engagement auprès de {team}. Les grands projets se construisent aussi dans l'adversité.",
    'fanpost.sponsorRegionalLoss.6': "{team} traverse une période délicate en {comp}. {sponsor} le rappelle : un partenariat, ça se vit dans les hauts comme dans les bas.",
    'fanpost.sponsorRegionalLoss.7': "{sponsor} ne lâche rien. {comp} n'a pas été à la hauteur des attentes pour {team}, mais notre soutien, lui, ne change pas.",
    'fanpost.sponsorIntlWin.0': "{team} au sommet de {comp} — {sponsor} est honoré d'accompagner une équipe qui marque l'histoire de cette discipline à l'échelle mondiale.",
    'fanpost.sponsorIntlWin.1': "De {comp} jusqu'à la scène mondiale : {sponsor} savoure ce succès aux côtés de {team}, notre partenaire d'exception.",
    'fanpost.sponsorIntlWin.2': "{sponsor} tient à féliciter {team} pour son parcours remarquable en {comp}. Représenter notre marque à ce niveau, c'est une immense fierté.",
    'fanpost.sponsorIntlWin.3': "Quel parcours en {comp} ! {sponsor} est fier d'avoir vécu cette aventure internationale aux côtés de {team}.",
    'fanpost.sponsorIntlWin.4': "On n'aurait pas rêvé mieux : {sponsor} félicite {team} pour cette performance en {comp}, une fierté immense pour toute notre équipe.",
    'fanpost.sponsorIntlWin.5': "{team} écrit une nouvelle page à {comp}, et {sponsor} est fier d'y associer son nom. L'ambition mondiale, ça se construit ainsi.",
    'fanpost.sponsorIntlWin.6': "{sponsor} n'oubliera pas ce {comp}. Bravo {team}, vous avez porté nos couleurs au sommet.",
    'fanpost.sponsorIntlWin.7': "De notre petite structure jusqu'à {comp} : {sponsor} n'en revient toujours pas de ce que {team} vient d'accomplir. Merci pour cette fierté.",
    'fanpost.sponsorIntlLoss.0': "{comp} s'est terminé plus tôt que prévu pour {team}. {sponsor} reste un partenaire de long terme et se projette déjà sur les prochaines échéances internationales.",
    'fanpost.sponsorIntlLoss.1': "L'ambition mondiale reste intacte. {sponsor} soutient {team} après cette sortie précoce en {comp} et croit en la prochaine étape.",
    'fanpost.sponsorIntlLoss.2': "{sponsor} salue malgré tout la qualification de {team} en {comp} — l'objectif était d'y être, l'expérience internationale compte.",
    'fanpost.sponsorIntlLoss.3': "Résultat décevant pour {team} en {comp}, mais {sponsor} garde toute sa confiance dans ce groupe pour la suite.",
    'fanpost.sponsorIntlLoss.4': "Même si {comp} ne s'est pas terminé comme espéré, {sponsor} est fier d'avoir vu {team} représenter nos couleurs sur la scène internationale.",
    'fanpost.sponsorIntlLoss.5': "{comp} s'arrête ici pour {team}, mais {sponsor} regarde déjà vers l'avenir. Notre engagement pour les prochaines campagnes internationales reste total.",
    'fanpost.sponsorIntlLoss.6': "L'aventure {comp} touche à sa fin plus tôt que prévu pour {team}. {sponsor} retient l'essentiel : cette équipe avait sa place sur la scène internationale.",
    'fanpost.sponsorIntlLoss.7': "{comp} ne se termine pas comme on l'espérait, mais {sponsor} est fier d'avoir vu {team} défendre nos couleurs si loin. On continue, ensemble.",
    ...
    'cal.regularComplete': 'Saison régulière terminée — consultez le classement final ci-dessous.',
    'cal.proceedToPlayoffs': 'Passer aux playoffs',
    ...
    'intl.groupsComplete': 'Phase de groupes terminée — consultez le classement final ci-dessous.',
    'intl.proceedToBracket': 'Passer au bracket',
    ...
    'directive.title': 'Consigne stratégique',
    'directive.hint': "Donnez UNE consigne à votre équipe pour cette game. Elle influence les événements du match — jamais le rythme d'apparition des objectifs neutres.",
    'directive.recommended': '(recommandé)',
    'directive.activeLabel': 'Consigne : {name} ({source})',
    'directive.source.coach': 'coach',
    'directive.source.team': 'équipe',
    'directive.objectives.label': 'Objectifs neutres',
    'directive.objectives.desc': 'Priorité aux dragons, hérauts, nashors et grubs.',
    'directive.aggression.label': 'Agressivité',
    'directive.aggression.desc': 'Multipliez les ganks et les prises en lane, imposez le tempo.',
    'directive.siege.label': 'Siège / tours',
    'directive.siege.desc': "Faites pression sur les lignes et enchaînez les tours.",
    'directive.teamfight.label': "Combats d'équipe",
    'directive.teamfight.desc': 'Cherchez les regroupements et les teamfights décisifs.',
    'directive.scaling.label': 'Prudence / scaling',
    'directive.scaling.desc': 'Temporisez, évitez les combats risqués et laissez le temps à vos champions de late game.',
    'directive.team.label': "Laisser l'équipe décider",
    'directive.team.desc': "L'équipe choisit elle-même son approche, selon son intelligence de jeu (shotcalling, mental).",
    ...
    'tutorial.step.bootcamp.title': 'Le bootcamp',
    'tutorial.step.bootcamp.text': "Dépensez du budget en stage intensif pour renforcer la coordination de l'équipe, la maîtrise des champions, ou apprendre de nouveaux champions.",
    ...
    'tutorial.step.fans.title': 'Ferveur des fans',
    'tutorial.step.fans.text': "Votre prestige n'est plus une simple récompense : il alimente désormais une échelle de ferveur avec de vrais bonus.",
    'tutorial.step.fansTiers.title': 'Palier & humeur',
    'tutorial.step.fansTiers.text': "Chaque palier de prestige débloque des avantages (dividende de budget, coaching, énergie, soutien en match). L'humeur de vos fans module ces gains.",
    'tutorial.step.fansFeed.title': 'Le fil des fans',
    'tutorial.step.fansFeed.text': "Vos fans, médias et détracteurs réagissent à chacun de vos résultats et à vos titres — du lore, rien que pour l'ambiance.",
  ...
  en: {
    ...
    'fans.feedPrev': 'Previous',
    'fans.feedNext': 'Next',
    'fans.feedPage': 'Page {n} / {total}',
    'fans.feedCtxMatch': 'Match {my} vs {opp} — Competition: {comp} / {stage}',
    'fans.feedCtxTitle': 'Competition: {comp} — {stage}',
    'fans.feedMatchday': 'matchday {n}',
    'fans.feedGroupStage': 'Group stage',
    'fans.feedStageChampion': 'Champion',
    'fans.feedStageEliminated': 'Eliminated',
    ...
    // -- Sponsor post bank for the fan feed (v1.19.3) --
    'fanpost.sponsorRegionalWin.0': "{sponsor} is proud to partner with an organization that shines on the world stage. Congratulations to {team} on this {comp} title — further proof that excellence is our shared standard.",
    'fanpost.sponsorRegionalWin.1': "At {sponsor}, we invest in champions. {team} just proved it in {comp}. Onward.",
    'fanpost.sponsorRegionalWin.2': "{sponsor} warmly congratulates {team} on their run in {comp}. This is exactly why we're partners.",
    'fanpost.sponsorRegionalWin.3': "Proud to carry {team}'s colors this season. {sponsor} salutes a well-earned qualification in {comp}.",
    'fanpost.sponsorRegionalWin.4': "Small organization, big emotions: {sponsor} has been with {team} from the start, and this {comp} success means a great deal to us.",
    'fanpost.sponsorRegionalWin.5': "{comp} confirms what we already knew: {team} belongs among the elite. {sponsor} is proud to carry this ambition alongside them.",
    'fanpost.sponsorRegionalWin.6': "A great {comp} season for {team}, and {sponsor} is proud to be part of it. Thank you for these emotions.",
    'fanpost.sponsorRegionalWin.7': "{sponsor} raises a glass to {team}: what a {comp} season! We're growing together, match after match.",
    'fanpost.sponsorRegionalLoss.0': "{sponsor} remains fully committed to {team}. A {comp} season below expectations, but our confidence in this project hasn't wavered.",
    'fanpost.sponsorRegionalLoss.1': "The {comp} results don't reflect the potential we see in {team}. {sponsor} keeps investing in this shared ambition.",
    'fanpost.sponsorRegionalLoss.2': "{sponsor} acknowledges a difficult {comp} season for {team}. The partnership continues, with a quick bounce-back expected.",
    'fanpost.sponsorRegionalLoss.3': "Not the result we hoped for in {comp}, but {sponsor} still believes in the {team} project. We rise together.",
    'fanpost.sponsorRegionalLoss.4': "{sponsor} stands behind {team} despite a tough {comp} season. This is when a true partner shows itself.",
    'fanpost.sponsorRegionalLoss.5': "{sponsor} looks at this {comp} season with a clear eye, without ever questioning its commitment to {team}. Great projects are also built through adversity.",
    'fanpost.sponsorRegionalLoss.6': "{team} is going through a rough patch in {comp}. {sponsor} reminds everyone: a partnership is lived through the highs and the lows.",
    'fanpost.sponsorRegionalLoss.7': "{sponsor} isn't backing down. {comp} didn't live up to expectations for {team}, but our support hasn't changed.",
    'fanpost.sponsorIntlWin.0': "{team} at the top of {comp} — {sponsor} is honored to stand alongside a team making history in this discipline on the world stage.",
    'fanpost.sponsorIntlWin.1': "From {comp} to the world stage: {sponsor} savors this success alongside {team}, our exceptional partner.",
    'fanpost.sponsorIntlWin.2': "{sponsor} wants to congratulate {team} on their remarkable run in {comp}. Representing our brand at this level is an immense source of pride.",
    'fanpost.sponsorIntlWin.3': "What a run in {comp}! {sponsor} is proud to have lived this international adventure alongside {team}.",
    'fanpost.sponsorIntlWin.4': "We couldn't have dreamed of anything better: {sponsor} congratulates {team} on this {comp} performance, an immense source of pride for our whole team.",
    'fanpost.sponsorIntlWin.5': "{team} writes a new page at {comp}, and {sponsor} is proud to have its name attached. That's how global ambition is built.",
    'fanpost.sponsorIntlWin.6': "{sponsor} won't forget this {comp}. Well done {team}, you carried our colors to the top.",
    'fanpost.sponsorIntlWin.7': "From our small organization all the way to {comp}: {sponsor} still can't believe what {team} just accomplished. Thank you for this pride.",
    'fanpost.sponsorIntlLoss.0': "{comp} ended sooner than expected for {team}. {sponsor} remains a long-term partner and is already looking ahead to the next international events.",
    'fanpost.sponsorIntlLoss.1': "The global ambition remains intact. {sponsor} supports {team} after this early exit at {comp} and believes in the next step.",
    'fanpost.sponsorIntlLoss.2': "{sponsor} still salutes {team}'s qualification for {comp} — the goal was to be there, and international experience counts.",
    'fanpost.sponsorIntlLoss.3': "A disappointing result for {team} at {comp}, but {sponsor} keeps full confidence in this group going forward.",
    'fanpost.sponsorIntlLoss.4': "Even though {comp} didn't end as hoped, {sponsor} is proud to have seen {team} represent our colors on the international stage.",
    'fanpost.sponsorIntlLoss.5': "{comp} ends here for {team}, but {sponsor} is already looking ahead. Our commitment to the next international campaigns remains total.",
    'fanpost.sponsorIntlLoss.6': "The {comp} adventure ends sooner than expected for {team}. {sponsor} keeps the essential in mind: this team belonged on the international stage.",
    'fanpost.sponsorIntlLoss.7': "{comp} doesn't end the way we hoped, but {sponsor} is proud to have seen {team} defend our colors so far. We carry on, together.",
    ...
    'cal.regularComplete': 'Regular season complete — check the final standings below.',
    'cal.proceedToPlayoffs': 'Proceed to playoffs',
    ...
    'intl.groupsComplete': 'Group stage complete — check the final standings below.',
    'intl.proceedToBracket': 'Proceed to bracket',
    ...
    // -- Strategic directives (v1.19.0) --
    'directive.title': 'Strategic directive',
    'directive.hint': "Give your team ONE directive for this game. It influences the match's events — never the spawn rate of neutral objectives.",
    'directive.recommended': '(recommended)',
    'directive.activeLabel': 'Directive: {name} ({source})',
    'directive.source.coach': 'coach',
    'directive.source.team': 'team',
    'directive.objectives.label': 'Neutral objectives',
    'directive.objectives.desc': 'Prioritize dragons, heralds, barons and voidgrubs.',
    'directive.aggression.label': 'Aggression',
    'directive.aggression.desc': 'Multiply ganks and lane kills, seize the tempo.',
    'directive.siege.label': 'Siege / towers',
    'directive.siege.desc': 'Pressure the lanes and chain down towers.',
    'directive.teamfight.label': 'Teamfights',
    'directive.teamfight.desc': 'Look for grouped fights and decisive teamfights.',
    'directive.scaling.label': 'Patience / scaling',
    'directive.scaling.desc': 'Play it safe, avoid risky fights and give your late-game champions time to come online.',
    'directive.team.label': 'Let the team decide',
    'directive.team.desc': 'The team picks its own approach, based on its game intelligence (shotcalling, mental).',
    ...
    'tutorial.step.bootcamp.title': 'Bootcamp',
    'tutorial.step.bootcamp.text': 'Spend budget on a bootcamp to boost team coordination, champion mastery, or learn new champions.',
    ...
    'tutorial.step.fans.title': 'Fanbase fervor',
    'tutorial.step.fans.text': 'Your prestige is no longer just a reward: it now powers a fervor ladder with real bonuses.',
    'tutorial.step.fansTiers.title': 'Tier & mood',
    'tutorial.step.fansTiers.text': "Each prestige tier unlocks perks (budget dividend, coaching, energy, in-match support). Your fans' mood scales those gains.",
    'tutorial.step.fansFeed.title': 'The fan feed',
    'tutorial.step.fansFeed.text': 'Your fans, media and critics react to every result and every title — pure lore, just for the atmosphere.',
    'tutorial.step.progression.title': 'Progression',
