...
const I18N = {
  fr: {
    ...
    'tutorial.step.draft.text': "Bannissez et sélectionnez vos champions avant chaque match, épaulé par l'assistant coach.",
  ...
  en: {
    ...
    'tutorial.step.draft.title': 'Draft',
    'tutorial.step.draft.text': "Ban and pick champions before each match, backed by the coaching assistant.",
    'tutorial.step.scouting.title': 'Scouting',
