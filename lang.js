...
const I18N = {
  fr: {
    ...
    'sponsor.clause.failureValue': 'Résiliation, remboursement au prorata (perte de prestige si le budget ne suffit pas à rembourser)',
  ...
  en: {
    ...
    'sponsor.clause.failureValue': "Termination, prorated refund (prestige loss if your budget can't cover it)",
