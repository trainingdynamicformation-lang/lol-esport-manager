...
const I18N = {
  fr: {
    ...
    'sponsor.clause.successValue': '+{pct}% l’an prochain',
    'sponsor.clause.partial': 'Objectifs partiellement atteints',
    'sponsor.clause.partialValue': 'Avertissement, -{pct}%',
    'sponsor.clause.failure': 'Aucun objectif atteint',
    'sponsor.clause.failureValue': 'Résiliation, remboursement intégral (plafonné à votre budget disponible ; le manque se traduit par une perte de prestige)',
  ...
  en: {
    ...
    'sponsor.clause.successValue': '+{pct}% next year',
    'sponsor.clause.partial': 'Objectives partially met',
    'sponsor.clause.partialValue': 'Warning, -{pct}%',
    'sponsor.clause.failure': 'No objective met',
    'sponsor.clause.failureValue': "Termination, full refund (capped at your available budget; any shortfall costs prestige)",
