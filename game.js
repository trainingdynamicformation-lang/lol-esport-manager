...
const TUTORIAL_STEPS = [
  ...
  { view: 'roster',      target: '.bootcamp-panel',                   titleKey: 'tutorial.step.bootcamp.title',    textKey: 'tutorial.step.bootcamp.text' },
  ...
  { view: 'fans',        target: '.nav-btn[data-view="fans"]',        titleKey: 'tutorial.step.fans.title',        textKey: 'tutorial.step.fans.text' },
  { view: 'fans',        target: '.fans-summary',                     titleKey: 'tutorial.step.fansTiers.title',   textKey: 'tutorial.step.fansTiers.text' },
  { view: 'fans',        target: '.fans-feed',                        titleKey: 'tutorial.step.fansFeed.title',    textKey: 'tutorial.step.fansFeed.text' },
